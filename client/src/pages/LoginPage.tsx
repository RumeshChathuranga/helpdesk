      ...
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center mb-8 select-none">
          <div className="flex items-center gap-2.5 mb-2">
            <div className="h-10 w-10 rounded-xl bg-primary flex items-center justify-center text-primary-foreground font-mono font-black text-xl shadow-[0_0_25px_rgba(123,17,19,0.35)]">
              H
            </div>
        ...
        <Card className="border border-border bg-card/60 backdrop-blur-md shadow-2xl rounded-2xl relative overflow-hidden">
          ...
          <CardHeader className="space-y-1.5 p-6 pb-4">
            ...
            <CardDescription className="text-center text-xs text-muted-foreground">Authorized personnel access only</CardDescription>
          </CardHeader>
